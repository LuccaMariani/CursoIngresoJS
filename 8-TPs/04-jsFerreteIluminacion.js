...
function CalcularPrecio () 
{
	...
	else
	{
		...
		else
		{
			if(cantidadLampara>4)//B C D E
			{
				...
				{
					precioConDescuento=precioSinDescuento*0.4;
				}
				//otraMarca descuento del 30%
				else
				{
					precioConDescuento=precioSinDescuento*0.3;
				}			
			}
			else
			{	
				...
				if(cantidadLampara>3)
				{
					...
					{
						precioConDescuento=precioSinDescuento*0.25;
					}
					//otra marca el descuento es del 20%.
					else
					{
						precioConDescuento=precioSinDescuento*0.2;
					}
				}
				else
				{
					//D 
					// Si compra 3  lamparitas bajo consumo marca "ArgentinaLuz"  el descuento es del 15%, si es  “FelipeLamparas” 
					...
					else
					{
						...
						{
							//10 %
							precioConDescuento=precioSinDescuento*0.1;
						}
						else{
							//5%.
	...
	if(precioConDescuento>119)
	{
		...
		precioFinal=precioConDescuento*0.1;
		impuesto=precioConDescuento*0.9;
